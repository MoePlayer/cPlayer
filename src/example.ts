...
window.addEventListener("load",
  function () {
    ...
    let playlist: IAudioItem[] = [
      {
        src: require('file-loader!./example/music-1.mp3').default,
        poster: require('./example/music-1.jpg').default,
        name: 'チルドレンレコード',
        artist: '96猫,伊東歌詞太郎',
      ...
      {
        src: require('file-loader!./example/music-2.mp3').default,
        poster: require('./example/music-2.png').default,
        name: 'ひねくれネジと雨',
        artist: 'ねこぼーろ',
      ...
      {
        src: require('file-loader!./example/music-3.mp3').default,
        poster: require('./example/music-3.jpg').default,
        name: 'In my room',
        artist: 'FELT',
        album: 'Grow Color'
      },
      {
        src: require('file-loader!./example/video-1.mp4').default,
        poster: require('./example/video-1.png').default,
